...
// solution 3, use iteration with stack.
...
public class Lowest_Common_Ancestor_of_a_Binary_Tree_3 {
    public static void main(String args[]) {
        //Solution Solution_obj = new Solution();
        System.out.println("In java code, Lowest_Common_Ancestor_of_a_Binary_Tree_3 main() is excuted.");
    }
}